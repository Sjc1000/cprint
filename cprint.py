...
if __name__ == '__main__':
    ...
    cprint('[.yellow]With [.italic]this[./italic] software you can easily color the output'
            ' of your terminal')
    cprint('[._green][.white]You can even color the [.bold]background of text! :D')
    cprint('[.red]You [.underline]can[./underline] make [.bold]errors[./bold] look nice!')
